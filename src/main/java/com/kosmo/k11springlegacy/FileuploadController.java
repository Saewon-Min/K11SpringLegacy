...
public class FileuploadController {
	...
	public void uploadPath(HttpServletRequest req,
		...
		// req.getSession().getServletContext() 이기 때문에 application 영역에 저장되는것을 알 수 있다.
	...
	public String uploadAction(Model model, MultipartHttpServletRequest req) {
		...
		// 폼값과 파일명을 저장 후 View로 전달하기 위한 맵 컬렉션 생성
		Map returnObj = new HashMap();
		
		try {
			//업로드폼의 file속성의 필드를 얻어온다.(여기서는 2개임)
