...
public class RequestMappingController {
	...
	public String getSearch(HttpServletRequest req , Model model) {
		System.out.println("RequestMethod.GET방식으로 폼값 전송하기");
		
		//request 객체를 통해 폼값 받기
	...
	/*
	ModelAndView객체
		: View로 전송할 데이터의 저장과 View를 호출하는
		2가지 기능을 동시에 처리할 수 있는 클래스
		- View설정 :참조변수.setViewName("뷰의 경로 및 파일명")
	...
	public ModelAndView postLogin(
		...
		/*
		ModelAndView객체를 반환하여 뷰를 호출한다. 해당
		메소드의 반환타입도 해당 객체 타입으로 지정한다.
		 */
		return mv;
	}
